...
#define AARCH64_PGTBL12_BLK_LOW_BLK_ATTR_SHIFT    (2)
#define AARCH64_PGTBL12_BLK_LOW_BLK_ATTR_MASK     (ULL_C(0x3ff))

#define AARCH64_PGTBL12_BLK_LOW_ATTR_TBL_SHIFT     (0)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_IDX_SHIFT     (2)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_NS_SHIFT      (5)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_NS_NOSECURE   \
	(ULL_C(0x1) << AARCH64_PGTBL12_BLK_LOW_ATTR_NS_SHIFT)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_NS_SECURE   \
	(ULL_C(0x0) << AARCH64_PGTBL12_BLK_LOW_ATTR_NS_SHIFT)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AP_SHIFT      (6)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AP_RW_ELHIGH  ( ULL_C(0x0) )
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AP_RW_EL0     ( ULL_C(0x40) )
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AP_RO_ELHIGH  ( ULL_C(0x80) )
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AP_RO_EL0     ( ULL_C(0xc0) )

#define AARCH64_PGTBL12_BLK_LOW_ATTR_SH_SHIFT      (8)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_SH_NS         ( ULL_C(0)     )
#define AARCH64_PGTBL12_BLK_LOW_ATTR_SH_OS         ( ULL_C(0x200) )
#define AARCH64_PGTBL12_BLK_LOW_ATTR_SH_IS         ( ULL_C(0x300) )

#define AARCH64_PGTBL12_BLK_LOW_ATTR_AF_SHIFT      (10)
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AF_ENABLE     (ULL_C(0x400))
#define AARCH64_PGTBL12_BLK_LOW_ATTR_AF_DISABLE    (ULL_C(0x0)  )

#define AARCH64_PGTBL12_BLK_LOW_ATTR_NG_SHIFT      (11)
...
#define AARCH64_PGTBL12_BLK_UPPER_BLK_ATTR_SHIFT  (51)
#define AARCH64_PGTBL12_BLK_UPPER_BLK_ATTR_MASK   (ULL_C(0xfff))
...
#define AARCH64_PGTBL3_BLK_LOW_BLK_ATTR_SHIFT     (2)
#define AARCH64_PGTBL3_BLK_LOW_BLK_ATTR_MASK      (ULL_C(0x3ff))
...
#define AARCH64_PGTBL3_BLK_UPPER_BLK_ATTR_SHIFT   (51)

#define AARCH64_PGTBL3_BLK_LOW_ATTR_TBL_SHIFT     (0)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_IDX_SHIFT     (2)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_NS_SHIFT      (5)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_AP_SHIFT      (6)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_SH_SHIFT      (8)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_AF_SHIFT      (10)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_NG_SHIFT      (11)
...
#define AARCH64_PGTBL3_BLK_LOW_ATTR_AF_DISABLE    (0)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_AF_ENABLE     (1)

#define AARCH64_PGTBL3_BLK_LOW_ATTR_TBL_INVALID   (0)
#define AARCH64_PGTBL3_BLK_LOW_ATTR_TBL_VALID     (1)
...
get_level1_ent_addr(uintptr_t ent) {
	...
	return ( PAGE_START(ent) & ~( AARCH64_PGTBL12_BLK_UPPER_BLK_ATTR_MASK << 
...
get_level12_ent_attr(uintptr_t ent) {
	...
	return ( (ent) & ( ( AARCH64_PGTBL12_BLK_LOW_BLK_ATTR_MASK << 
